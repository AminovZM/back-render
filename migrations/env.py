...
from src.basket.models import metadata as metadata_basket
...
target_metadata = [metadata_auth, metadata_operations, metadata_products, metadata_basket, metadata_order]
